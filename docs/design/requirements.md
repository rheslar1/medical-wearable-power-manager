...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for Medical Wearable Power Manager. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: RTOS power-management thread for a battery wearable that schedules sensor reads, enters deep sleep, and uses DMA for autonomous sampling. | Scenario tests and documentation review. |
